...
class RobotController:
    ...
    def set_target(self, pose, distance, angle_deg):
        ...
        Args:
            ...
            distance:  Distancia a recorrer (píxeles).
    ...
    def update(self, pose):
        ...
        dist_to_goal = np.hypot(
            self.target[0] - pose.x,
            self.target[1] - pose.y
        )
    ...
    # ------------------------------------------------------------------ #
    # Conversión a comandos de actuadores                                  #
    # ------------------------------------------------------------------ #
    ...
    def compute_command(self, info):
        ...
        """
        cmd = ControlCommand()  # Todo en cero → robot detenido
